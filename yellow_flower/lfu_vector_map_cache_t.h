#ifndef LFU_VECTOR_MAP_CACHE_T_H
#define LFU_VECTOR_MAP_CACHE_T_H
...
struct lfu_vector_map_cache_t {
	...
	lfu_vector_map_cache_t()=default;
	lfu_vector_map_cache_t(std::size_t capacity) : container(capacity) {;}
